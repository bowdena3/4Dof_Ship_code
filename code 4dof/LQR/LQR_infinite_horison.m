...
%     psi = ship_velocity(3);         % ship yaw angle [rads]
    ...
    W_theta = 0;      % Prevailing wind angle [degrees]
...
A_2 = jacobian(derivitives, [x, y, phi, psi, u, v, p, r]);
B_2 = jacobian(derivitives, [delta, Thrust, W_delta]);
...
save('C:/Users/arthu/OneDrive/Documents/MSC Individual/code/code 4dof/data/rorocontrol.mat','LQR');
